  ...
  <el-container class="home-container">
    ...
    <el-header>
      <div>
        ...
        <span>智能教室管理系统-教师</span>
      </div>
      <div>
        <div style="font-size: medium; padding-right: 15px">teacher</div>
...
export default {
  ...
  data() {
    return {
      ...
      iconsObj: {
        // 一级菜单的icon图标
        109: 'iconfont icon-xiaoquguanli',
