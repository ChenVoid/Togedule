<template>
  <div>
    <!-- 面包屑导航区域 -->
    <Breadcrumb name1="教室管理" name2="教室使用信息查询" />
    <!-- 卡片视图区域 -->
    <el-card class="box-card">
      ...
      <el-table :data="data_test" stripe style="width: 100%" border>
        ...
        <el-table-column prop="st_time" label="开始时间"></el-table-column>
        <el-table-column prop="ed_time" label="结束时间"></el-table-column>
        <el-table-column prop="name" label="使用者"></el-table-column>
